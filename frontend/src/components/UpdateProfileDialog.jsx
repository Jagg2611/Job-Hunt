...
import { setUser } from "@/redux/authSlice"; // Import the action for setting the user
          ...
          <form onSubmit={submitHandler}>
            <div className="grid gap-4 py-4">
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Input
                  id="name"
                  name="name" // Change to match input key
                  type="text"
                  value={input.fullname}
                  onChange={changeEventHandler}
                  className="col-span-3 border-gray-500 hover:border-black"
                />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
